...
window.carouselData = [
  {
    ...
    content: [
      ...
      { type: 'divider', content: '---' },
      { type: 'text', content: '"Fake it till you make it"', class: 'slogan', italic: true }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    theme: 'tech-green',
    content: [
      { type: 'task', text: '[游戏] 鸣潮3.3', checked: false }
    ]
  },
  {
    id: 4,
    ...
    content: [
      { type: 'text', content: 'vup: 心翎XinLing (号不创了)', class: 'center' }
    ]
  }
]
